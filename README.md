# Player AVPlay with 8K support

This application demonstrates the usage of `webapis.avplay` API for 8K content playback. With this API it is possible to have a video player in application. AVPlay is alternative to HTML5 player and has many advantages over it including: wider range of codecs and formats, DRMs support, hardware acceleration.
...
2019 and newer with 8K support
...
```
PlayerAvplay8K/ - PlayerAvplay8K sample app root folder
│
